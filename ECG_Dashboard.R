...
get_epochs_around_feedback <- function(ECG_data,fbt,pre=1000,post=10000,sample_rate){
...
a2f <- get_epochs_around_feedback(ECG_data,fbt,pre=1000,post=10000,sample_rate)
...
get_good_ECG <- function(blocks,a2f){
  ...
  Ngood_df <- dplyr::tibble(perGood)
  return(Ngood_df)
}

Ngood_df <- get_good_ECG(blocks,a2f)
