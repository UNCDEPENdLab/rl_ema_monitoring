...
run_ema(save_lite=TRUE, replot=TRUE, render=TRUE, push=TRUE, pull=FALSE, sched=FALSE, physio=FALSE, cleanup_data=TRUE, nthreads = 2, force_proc=TRUE, force_reload=TRUE, log_level=TRACE, sink_file=NULL)
# Run this line #
