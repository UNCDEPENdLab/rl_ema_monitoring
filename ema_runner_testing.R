...
run_ema(save_lite=FALSE, replot=TRUE, render=TRUE, push=FALSE, pull=FALSE, sched=TRUE, physio=TRUE, cleanup_data=TRUE, nthreads = 2, force_proc=TRUE, force_reload=TRUE, log_level=TRACE, sink_file=NULL)
# Run this line #
