...
run_ema(save_lite=TRUE, replot=TRUE, render=FALSE, push=FALSE, pull=FALSE, sched=TRUE, physio=FALSE, cleanup_data=TRUE, nthreads = 1, force_proc=TRUE, force_reload=TRUE, log_level=TRACE, sink_file=NULL)
# Run this line #
