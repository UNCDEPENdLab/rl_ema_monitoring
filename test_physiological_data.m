...
clear; clc
name='Michael'; %insert subject ID as a string
...
[Ntotal, Ngood, epoch_data]=EEGanalysis_test(name); %test EEG data
[HRoutcome, stats, HR] = getHRperOutcome(name, 1);%test HR data
