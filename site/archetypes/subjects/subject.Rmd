...
rc<- redcap_pull(uri="https://www.ctsiredcap.pitt.edu/redcap/api/", token='AE44DDA12DC3A51784F9FCD2587CABCE', activeList="[[params$id]]")
```
...
if (id = "Abbegail"){compliance_filtered_2<- filter(compliance_filtered_2, scheduled_time < "2020-12-11" ) }
...
## Overview 
```{r overview of participant, echo=FALSE, warning=FALSE}
...
Individual_Overview <- filter(ID_Overview, ID=="[[params$id]]") #change for copying for other participants
