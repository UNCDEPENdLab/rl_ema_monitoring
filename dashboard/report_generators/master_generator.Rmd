...
knitr::opts_knit$set(root.dir = '~/Downloads/rl_ema_monitoring') #probably need to change this root dir for general use
library(kableExtra)
library(dplyr)
#Probably need to change these paths for general use
